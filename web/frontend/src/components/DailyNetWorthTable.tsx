    ...
    <div className="fintech-card p-6 overflow-hidden">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-5">
        <div className="flex items-center space-x-2.5">
          ...
          <div>
            <h3 className="text-sm font-bold text-slate-900 tracking-tight">每日資產淨值明細與變化歷史</h3>
            <p className="text-xs text-slate-500 font-medium">每日收盤結算 · 單日淨值損益對比 · 跨日資產分佈追蹤</p>
          </div>
        </div>

        {stats && (
          <div className="flex items-center gap-2 text-xs flex-wrap">
            <span className="px-3 py-1 rounded-xl bg-slate-100 border border-slate-200 text-slate-600 font-medium">
